...
async def get_distance(
    start_longitude : Decimal = Query(ge=0, le=180),
    start_latitude: Decimal = Query(ge=0, le=180),
    end_longitude: Decimal = Query(ge=0, le=180),
    end_latitude: Decimal = Query(ge=0, le=180)
):
